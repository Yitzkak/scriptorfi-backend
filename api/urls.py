...
from .views import (
    ...
    AdminFileListView, AdminMarkAsPaidView, SubmitPaymentForReviewView, get_notifications, mark_notification_as_read,
...
urlpatterns = [
    ...
    path('transcriptions/<int:file_id>/download/', TranscriptDownloadView.as_view(), name='transcript_download'),
    ...
    path('payment/submit-for-review/', SubmitPaymentForReviewView.as_view(), name='submit_payment_for_review'),
